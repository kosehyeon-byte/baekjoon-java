...
public class OvenTimer {
	public static void main(String[] args) {
		...
		int minsum = minute + cookmin;
		int newhour = hour + (minsum / 60);
		minute = minsum - (minsum / 60) * 60;
		
		if (newhour >= 24) {
			newhour = newhour - 24;
		}
		
		System.out.println(newhour + " " + minute);
...
/* (brief code)
int minsum = minute + cookmin;
int newhour = (hour + (minsum / 60)) % 24;
int newminute = minsum % 60;
